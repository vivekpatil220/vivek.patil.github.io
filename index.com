...
<html lang="en">
  <head>
    <title>Vivek Patil portfolio</title>
    <meta charset="utf-8">
...
.zoom-effect:hover {
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Vvek Patil</a>
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
						<span class="subheading"> Hey, </span>	
		          		<span class="subheading">What's up!</span>
			            <h1 class="mb-4 mt-3">I'm <span>Vivek Patil</span></h1>
						...
						<!-- <br> -->
			            <p><a href="https://www.linkedin.com/in/vivek-patil-153093304" class="btn btn-primary py-3 px-4">LinkedIn</a> 
							<a href="https://github.com/vivekpatil220" class="btn btn-white btn-outline-yellow py-3 px-4">GitHub</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
				...
				<!-- <div class="row d-flex"> -->
						...
						<div class="img-about img d-flex align-items-stretch">
							<div class="overlay">
								<div class="row">
									...
									<div class="col-sm-6 col-md-7">
									  <div class="about-info">
										<p><span class="title-s">Name: </span> <span>Vivek Patil</span></p>
										<p><span class="title-s">Undergraduation: </span> <span>NMIMS University [B.TECH AI ML]</span></p>
										<p><span class="title-s">Graduation Year: </span> <span>1 Year</span></p>
										<p><span class="title-s">Address: </span> <span>Shirpur, Maharashtra, India (425405) </span></p>
									  </div>
									</div>
								  </div>
								...
								<div class="skill-mf">
									...
									<span>Editing</span> <span class="pull-right">85%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar" style="width: 85%" aria-valuenow="90" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									
									<span>Communication</span> <span class="pull-right">90%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									
									<span>Other Skills</span> <span class="pull-right">90%</span>
									<div class="progress">
					...
					<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<p>
									...
									Hello! I'm Vivek Patil, a first-year B.Tech student in Artificial Intelligence and Machine Learning at NMIMS Shirpur. I have a strong passion for technology and am excited to dive deep into AI and ML. skilled in Python and C++, I enjoy working on projects that solve real-world problems.
									
									I'm an active member of tech communities at NMIMS and participate in hackathons to hone my skills.  I am passionate about AI applications in healthcare and robotics, eager to explore these fields further, I love playing online games, exploring new technologies, working on personal coding projects , coding, and outdoor activities, eager to connect with fellow enthusiasts and professionals in AI and ML.
									
									Thank you for visiting my portfolio. </p>
								<ul class="about-info mt-4 px-md-0 px-2">
									<li class="d-flex"><span>Profile:</span> <span>Student</span></li>
									<li class="d-flex"><span>Domain:</span> <span>Artificial Intelligence and Machine Learning</span></li>
									...
									<li class="d-flex"><span>Other Skills:</span> <span>Communication Skills, Teamwork and Collaboration, Video Editing, Photo Editing, Programming Languages (C++, Pyhton), Excel, Critical Thinking, Problem Solving</span></li>
									<li class="d-flex"><span>Interest:</span> <span>Traveling, Play Online Games, Editing ,	Explore new things</span></li>
						...
						<div class="counter-wrap ftco-animate d-flex mt-md-3">
							<div class="text">
								<p class="mb-4">
									<!-- <span class="number" data-number="0">0</span> <span>+</span> -->
									<span>&nbsp; Projects --->   "Work in Progress" </span>
								</p>
								<p><a href="https://leetcode.com/u/vasu220//" class="btn btn-primary py-3 px-3">leetcode</a></p>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section ftco-no-pb" id="resume-section">
    	<div class="container">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p><a href="https://linktr.ee/vivek_patil_" class="btn btn-primary py-3 px-3">Download Resume</a></p>
          </div>
        </div>
			...
			<div class="row">
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					...
    					<span class="position">Pratap college</span>
    			...
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					...
    					<span class="position">NMIMS University</span>
...
<!-- 
      ...
      <div class="container">
		<div class="row d-md-flex align-items-center">
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text">
                <strong class="number" data-number="none">0</strong>
                <span>Projects</span>
              </div>
            </div>
          </div>
			...
			<!-- <div class="container"> -->
				<div class="row justify-content-center">
					<div class="col-md-7 ftco-animate text-center">
						...
						<div class="heading"> <h4> Under Development </h4>
						<br>
						<p><a href="https://github.com/vivekpatil220" class="btn btn-primary py-3 px-5">GitHub</a></p>
						</div>
					</div>
				</div>
			<!-- </div> -->
        ...
        <div class="row d-flex contact-info mb-5">
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p>Shirpur, Maharashtra, India (425405)</p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://0101010101">+ 91 9322019398</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="mailto:info@yoursite.com">vivekp9442@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
		  ...
		  <div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 ftco-animate text-center">
					<h2>Have a<span> Question?  </span> <a href="https://forms.gle/svKx35daUWaaEEDe9" class="btn btn-primary py-3 px-5">Click Here</a> </h2>
				</div>
			</div>
				<br>
					<ul class="ftco-footer-social list-unstyled d-flex justify-content-center align-items-center mb-0">
					  ...
					  <li class="ftco-animate"><a href="https://www.linkedin.com/in/vivek-patil-153093304"><span class="icon-linkedin"></span></a></li>  
					  <!-- <li class="ftco-animate"><a href="https://twitter.com/rishabhnmishra"><span class="icon-twitter"></span></a></li> -->
					  <!-- <li class="ftco-animate"><a href="https://t.me/devil_vivek_143"><span class="icon-Telegram"></span></a></li> -->
				      <li class="ftco-animate"><a href="https://https://www.instagram.com/yaa.its_vasu_/"><span class="icon-instagram"></span></a></li>
					</ul>
				<br>
		   </div>
   </div>
	...
	<section class="ftco-section contact-section ftco-no-pb" id="contact-section">
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3">
			<div class="col-md-7 heading-section text-center ftco-animate">
			  <h1 class="big big-2">THANK YOU</h1>
